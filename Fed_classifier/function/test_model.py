...
from function.lr_scheduler import get_cosine_schedule_with_warmup
from models.simple_model import ResModel
...
class ResNet(torch.nn.Module):
    def __init__(self, block, layers, num_classes, in_ch = 3):
        ...
        self.in_channels = 16   # 64

        self.conv = conv3x3(in_ch, self.in_channels)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--is_save", action="store_true", help="Whether to save the model")
    ...
    batch_size = args.batch_size   # 测试 batch size 的影响 ！ 100, 128, 64
    learning_rate = args.lr     #0.01    # 0.001
    ...
    optimizer = torch.optim.SGD(model.parameters(), lr=learning_rate,   # 不用momentum top acc: 0.7273, at 96 epoch
                                momentum= 0.9     # top acc: 0.8457, at 98 epoch
                                )
