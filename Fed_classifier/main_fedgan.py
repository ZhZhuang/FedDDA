...
from utils import get_user_data, fmnist_noniid, get_logger
...
def load_model(logger):
    ...
    # t_dataset = fileDataset("/home/user/PycharmProjects/FedConfusion/data/generate_noniid_imgs_6w", transform=transform)
    # data_list = torch.utils.data.random_split(t_dataset, [2**10 * 5 for _ in range(n_client)])
...
def main():
    ...
    logger = get_logger("fedgan", save_path=".", level='INFO', file_name="log_fedgan_0.txt")
